...
def build_system_prompt():
    ...
    prompt = (
        ...
        "Пример: игрок весит 80 кг -> 80 х 2.2 / 2 = 88 -> для Bauer ближайший 87, для CCM ближайший 85.\n"
        ...
        "9. НИКОГДА не упоминай цену первым и не пиши фразы типа 'все клюшки по одной цене' - цену называй только когда клиент сам спросит или когда разговор дошёл до оформления заказа\n"
