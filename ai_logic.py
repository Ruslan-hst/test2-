...
def build_system_prompt():
    ...
    prompt = (
        ...
        "- Доставка по всей России через СДЭК. Другие ТК (ПЭК и т.д.) - только если в населённом пункте клиента нет СДЭК.\n"
        ...
        "- Про UDS говори ТОЛЬКО когда клиент спрашивает про цену или скидку. Не предлагай UDS в начале разговора.\n\n"
        ...
        "4. НЕ используй звёздочки, решётки и другую markdown-разметку - пиши обычным текстом\n"
