...
♻️ ОФОРМИТЬ КАРТУ:
📱 ТГ: t.me/UDS_hockey_sticks_top_bot
📱 MAX: max.ru/id164908988785_2_bot

*займёт менее 1 мин ⚡️"""
...
После регистрации напишите мне — помогу с подбором клюшки 🏒"""

MANAGER_TEXT = """📞 Передаю тебя менеджеру!

Напиши сюда — ответим быстро:
👉 t.me/hockey_top_bot"""
...
async def handle_message(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if any(w in text for w in ["наличие", "есть", "склад", "что есть"]):
        ...
        await update.message.reply_text(UDS_TEXT)
